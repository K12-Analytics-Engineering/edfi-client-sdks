...
class LocationsApi(object):
    ...
    def deletes_locations(self, **kwargs):  # noqa: E501
        ...
        :return: list[TrackedChangesEdFiLocationDelete]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def deletes_locations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[TrackedChangesEdFiLocationDelete]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def key_changes_locations(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.key_changes_locations(async_req=True)
        >>> result = thread.get()
        ...
        :param bool total_count: Indicates if the total number of items available should be returned in the 'Total-Count' header of the response.  If set to false, 'Total-Count' header will not be provided.
        :param str snapshot_identifier: Indicates the Snapshot-Identifier that should be used.
        :return: list[TrackedChangesEdFiLocationKeyChange]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.key_changes_locations_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.key_changes_locations_with_http_info(**kwargs)  # noqa: E501
            return data

    def key_changes_locations_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves resources key changes based on change version.  # noqa: E501

        This operation is used to retrieve identifying information about resources whose key values have been changed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.key_changes_locations_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method key_changes_locations" % key
                )
            params[key] = val
        del params['kwargs']

        if self.api_client.client_side_validation and ('limit' in params and params['limit'] > 5000):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `key_changes_locations`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and ('limit' in params and params['limit'] < 0):  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `key_changes_locations`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/ed-fi/locations/keyChanges', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[TrackedChangesEdFiLocationKeyChange]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
