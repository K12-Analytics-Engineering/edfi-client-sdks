...
class EdFiDisciplineIncident(object):
    ...
    def incident_cost(self):
        ...
        The value of any quantifiable monetary loss directly resulting from the discipline incident. Examples include the value of repairs necessitated by vandalism of a school facility, or the value of personnel resources used for repairs or consumed by the incident.  # noqa: E501
    ...
    def incident_date(self):
        ...
        The month, day, and year on which the discipline incident occurred.  # noqa: E501
    ...
    def incident_location_descriptor(self):
        ...
        Identifies where the discipline incident occurred and whether or not it occurred on school.  # noqa: E501
    ...
    def reporter_description_descriptor(self):
        ...
        Information on the type of individual who reported the discipline incident. When known and/or if useful, use a more specific option code (e.g., \"Counselor\" rather than \"Professional Staff\").  # noqa: E501
    ...
    def reporter_name(self):
        ...
        Identifies the reporter of the discipline incident by name.  # noqa: E501
