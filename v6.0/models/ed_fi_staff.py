...
class EdFiStaff(object):
    ...
    def maiden_name(self):
        ...
        The individual's maiden name.  # noqa: E501
    ...
    def years_of_prior_professional_experience(self):
        ...
        The total number of years that an individual has previously held a similar professional position in one or more education institutions prior to the current school year.  # noqa: E501
    ...
    def years_of_prior_teaching_experience(self):
        ...
        The total number of years that an individual has previously held a teaching position in one or more education institutions prior to the current school year.  # noqa: E501
