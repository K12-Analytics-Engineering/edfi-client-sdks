...
class EdFiLearningStandard(object):
    ...
    def academic_subjects(self):
        ...
        An unordered collection of learningStandardAcademicSubjects. Subject area for the learning standard.  # noqa: E501
    ...
    def success_criteria(self):
        ...
        One or more statements that describes the criteria used by teachers and students to check for attainment of a learning standard. This criteria gives clear indications as to the degree to which learning is moving through the Zone or Proximal Development toward independent achievement of the learning standard.  # noqa: E501
