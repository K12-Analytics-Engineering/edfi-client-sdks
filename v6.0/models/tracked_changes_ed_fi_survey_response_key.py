...
class TrackedChangesEdFiSurveyResponseKey(object):
    ...
    def __init__(self, survey_response_identifier=None, namespace=None, survey_identifier=None, _configuration=None):  # noqa: E501
        """TrackedChangesEdFiSurveyResponseKey - a model defined in Swagger"""  # noqa: E501
    ...
    def survey_response_identifier(self):
        """Gets the survey_response_identifier of this TrackedChangesEdFiSurveyResponseKey.  # noqa: E501

        The identifier of the survey typically from the survey application.  # noqa: E501

        :return: The survey_response_identifier of this TrackedChangesEdFiSurveyResponseKey.  # noqa: E501
        :rtype: str
        """
    ...
    def survey_response_identifier(self, survey_response_identifier):
        """Sets the survey_response_identifier of this TrackedChangesEdFiSurveyResponseKey.

        The identifier of the survey typically from the survey application.  # noqa: E501

        :param survey_response_identifier: The survey_response_identifier of this TrackedChangesEdFiSurveyResponseKey.  # noqa: E501
        :type: str
        """
    ...
    @property
    def namespace(self):
        """Gets the namespace of this TrackedChangesEdFiSurveyResponseKey.  # noqa: E501

        Namespace for the survey.  # noqa: E501

        :return: The namespace of this TrackedChangesEdFiSurveyResponseKey.  # noqa: E501
        :rtype: str
        """
    ...
    def namespace(self, namespace):
        """Sets the namespace of this TrackedChangesEdFiSurveyResponseKey.

        Namespace for the survey.  # noqa: E501

        :param namespace: The namespace of this TrackedChangesEdFiSurveyResponseKey.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def survey_identifier(self):
        """Gets the survey_identifier of this TrackedChangesEdFiSurveyResponseKey.  # noqa: E501

        The unique survey identifier from the survey tool.  # noqa: E501

        :return: The survey_identifier of this TrackedChangesEdFiSurveyResponseKey.  # noqa: E501
        :rtype: str
        """
    ...
    def survey_identifier(self, survey_identifier):
        """Sets the survey_identifier of this TrackedChangesEdFiSurveyResponseKey.

        The unique survey identifier from the survey tool.  # noqa: E501

        :param survey_identifier: The survey_identifier of this TrackedChangesEdFiSurveyResponseKey.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TrackedChangesEdFiSurveyResponseKey, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrackedChangesEdFiSurveyResponseKey):
            return False
