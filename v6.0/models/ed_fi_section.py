...
class EdFiSection(object):
    ...
    def course_level_characteristics(self):
        ...
        An unordered collection of sectionCourseLevelCharacteristics. The type of specific program or designation with which the section is associated. This collection should only be populated if it differs from the course level characteristics identified at the course offering level.  # noqa: E501
    ...
    def educational_environment_descriptor(self):
        ...
        The setting in which a student receives education and related services.  # noqa: E501
    ...
    def medium_of_instruction_descriptor(self):
        ...
        The media through which teachers provide instruction to students and students and teachers communicate about instructional matters.  # noqa: E501
    ...
    def population_served_descriptor(self):
        ...
        The type of students the section is offered and tailored to.  # noqa: E501
    ...
    def programs(self):
        ...
        An unordered collection of sectionPrograms. Optional reference to program to which the section is associated.  # noqa: E501
    ...
    def section_name(self):
        ...
        A locally-defined name for the section, generally created to make the section more recognizable in informal contexts and generally distinct from the section identifier.  # noqa: E501
