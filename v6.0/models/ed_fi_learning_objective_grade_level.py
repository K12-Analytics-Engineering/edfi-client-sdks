...
class EdFiLearningObjectiveGradeLevel(object):
    ...
    def grade_level_descriptor(self):
        ...
        The grade level for which the learning objective is targeted. The semantics of null is assumed to mean that the learning objective is not associated with any grade level.  # noqa: E501
