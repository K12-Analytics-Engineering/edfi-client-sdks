...
class EdFiParentInternationalAddress(object):
    ...
    def begin_date(self):
        ...
        The first date the address is valid. For physical addresses, the date the individual moved to that address.  # noqa: E501
    ...
    def end_date(self):
        ...
        The last date the address is valid. For physical addresses, the date the individual moved from that address.  # noqa: E501
