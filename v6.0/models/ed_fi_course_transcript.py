...
class EdFiCourseTranscript(object):
    ...
    def earned_additional_credits(self):
        ...
        An unordered collection of courseTranscriptEarnedAdditionalCredits. The number of additional credits a student attempted and could earn for successfully completing a given course.  # noqa: E501
    ...
    def external_education_organization_name_of_institution(self):
        ...
        Name of the external institution where the student completed the course; to be used only when the reference external education organization is not available.  # noqa: E501
