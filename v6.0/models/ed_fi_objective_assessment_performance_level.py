...
class EdFiObjectiveAssessmentPerformanceLevel(object):
    ...
    def performance_level_indicator_name(self):
        """Gets the performance_level_indicator_name of this EdFiObjectiveAssessmentPerformanceLevel.  # noqa: E501

        The name of the indicator being measured for a collection of performance level values.  # noqa: E501

        :return: The performance_level_indicator_name of this EdFiObjectiveAssessmentPerformanceLevel.  # noqa: E501
        :rtype: str
        """
    ...
    def performance_level_indicator_name(self, performance_level_indicator_name):
        """Sets the performance_level_indicator_name of this EdFiObjectiveAssessmentPerformanceLevel.

        The name of the indicator being measured for a collection of performance level values.  # noqa: E501

        :param performance_level_indicator_name: The performance_level_indicator_name of this EdFiObjectiveAssessmentPerformanceLevel.  # noqa: E501
        :type: str
        """
        if (self._configuration.client_side_validation and
